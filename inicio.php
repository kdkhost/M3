...
<html lang="pt-BR">
    <head>
        ...
        <link rel="apple-touch-startup-image" href="splashscreens/iphone6plus_splash.png" media="(device-width: 414px) and (device-height: 736px) and (-webkit-device-pixel-ratio: 3)">
        ...
        <!-- iPad Pro (11 pol) -->
        <link rel="apple-touch-startup-image" href="splashscreens/ipadpro11_splash.png" media="(device-width: 834px) and (device-height: 1194px) and (-webkit-device-pixel-ratio: 2)">

        <!-- iPad Pro (12.9 pol 4ª Geração) -->
        ...
        <!-- Favicon -->
        <link rel="icon" type="image/png" href="/images/favicon/favicon.webp">
        ...
        <style>
            ...
            .platforms-popup-overlay.active {
                display: flex;
            }
            ...
            .popup-header {
                background: linear-gradient(135deg, #1a3ca8 0%, #2c5aa0 100%);
                color: white;
            ...
            .platform-card:hover {
                ...
                box-shadow: 0 10px 25px rgba(26, 60, 168, 0.15);
            }
            ...
            .transferegov-icon {
                background-image: url('https://www.gov.br/transferegov/pt-br/rede-parcerias/divulgacao/logomarcas/icone-transferegov-br.png');
                background-size: contain;    /* Faz a imagem caber no espaço */
                background-repeat: no-repeat; /* Impede que a imagem se repita */
                background-position: center;  /* Centraliza o ícone */
                display: inline-block;        /* Permite definir tamanho se for um span */
                width: 80px;                  /* Exemplo de largura */
                height: 80px;                 /* Exemplo de altura */
            }

            .salicweb-icon {
                background-image: url('https://image.winudf.com/v2/image/Y29tLmlvbmljZnJhbWV3b3JrLnNhbGljbW9iaWxlODA0NjAwX2ljb25feWt4NzU4bHM/icon.png?w=&fakeurl=1');
                background-size: contain;    /* Faz a imagem caber no espaço */
                background-repeat: no-repeat; /* Impede que a imagem se repita */
                background-position: center;  /* Centraliza o ícone */
                display: inline-block;        /* Permite definir tamanho se for um span */
    ...
    <body>
        <!-- Popup Modal para TRANSFEREGOV e SALICWEB -->
        <div class="platforms-popup-overlay" id="platformsPopup">
            <div class="platforms-popup">
                ...
                <div class="popup-header">
                    ...
                    <p class="subtitle">Trabalhamos com as principais ferramentas do mercado</p>
                </div>
                ...
                <div class="popup-content">
                    ...
                    <div class="popup-message">
                        <p>⚡ <strong>Agilidade e precisão</strong> na gestão dos seus projetos com nossas plataformas especializadas!</p>
                    </div>
                    
                    <div class="popup-buttons">
                        <a href="https://wa.me/<?= $whatsapp; ?>?text=Olá! Gostaria de saber mais sobre as plataformas TRANSFEREGOV e SALICWEB." 
                           class="btn-whatsapp" target="_blank">
                            <i class="fab fa-whatsapp"></i>
                            Saiba Mais
                        </a>
                        <button class="btn-dismiss" id="popupDismiss">
                            Agora Não
                        </button>
                    </div>
                </div>
...
<section class="client-logos section" id="parceiros">
    <div class="container">
        ...
        <div class="logos-carousel">
            <div class="logos-track">
                ...
                try {
                    ...
                    echo '<p class="no-logos">Carregando informações dos parceiros...</p>';
                }
                ?>
            </div>
        </div>
        ...
        <div class="floating-contact">
            <div id="contactOptions" class="contact-options">
                ...
                <?php if (isset($telefone) && $telefone != null) { ?>
                    <a href="tel:+<?= $telefone; ?>" class="contact-option">
                        <i class="fas fa-phone"></i> Ligar
                    </a>
                <?php } ?>
                <?php if (isset($whatsapp) && $whatsapp != null) { ?>
                    <a href="https://wa.me/<?= $whatsapp; ?>" class="contact-option whatsapp">
            ...
            <button id="contactButton" class="floating-btn">
        ...
        <script>
            ...
            phoneInput.addEventListener('input', function (e) {
                ...
                if (value.length > 11)
                    value = value.slice(0, 11); // Limit to 11 digits (Brazilian max)
            ...
            // Configuração do PWA - Popup de Instalação Personalizado
            document.addEventListener('DOMContentLoaded', function () {
                // Elementos do popup
    ...
    `;
                ...
                // Gerenciamento da instalação PWA
                let deferredPrompt;
                    ...
                    if (deferredPrompt) {
                        ...
                        deferredPrompt.userChoice.then((choiceResult) => {
                            if (choiceResult.outcome === 'accepted') {
                                ...
                                // Aqui você pode adicionar tracking ou outras ações
                            }
                            deferredPrompt = null;
                        });
                    }
                ...
                // Registro do Service Worker para todos os navegadores
                if ('serviceWorker' in navigator) {
                    window.addEventListener('load', () => {
                        navigator.serviceWorker.register('/sw.js')
                                .then(registration => {
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                // Elementos do popup
                const platformsPopup = document.getElementById('platformsPopup');
                const popupClose = document.getElementById('popupClose');
                const popupDismiss = document.getElementById('popupDismiss');
                
                // Verificar se o popup já foi exibido nesta sessão
                const popupShown = sessionStorage.getItem('platformsPopupShown');
                
                // Função para mostrar o popup
                function showPopup() {
                    platformsPopup.classList.add('active');
                    document.body.style.overflow = 'hidden'; // Prevenir scroll
                }
                
                // Função para ocultar o popup
                function hidePopup() {
                    platformsPopup.classList.remove('active');
                    document.body.style.overflow = 'auto'; // Restaurar scroll
                }
                
                // Função para marcar como exibido
                function markAsShown() {
                    sessionStorage.setItem('platformsPopupShown', 'true');
                }
                
                // Mostrar popup automaticamente após 3 segundos se não foi exibido
                if (!popupShown) {
                    setTimeout(() => {
                        showPopup();
                    }, 3000);
                ...
                platformsPopup.addEventListener('click', function(e) {
                    if (e.target === platformsPopup) {
                        hidePopup();
                        markAsShown();
                    }
                });
                ...
                document.addEventListener('keydown', function(e) {
                    if (e.key === 'Escape' && platformsPopup.classList.contains('active')) {
                        hidePopup();
                        markAsShown();
                    }
                });
                
                // Rastrear cliques no botão WhatsApp para análise
                const whatsappBtn = document.querySelector('.btn-whatsapp');
                if (whatsappBtn) {
                    whatsappBtn.addEventListener('click', function() {
                        // Aqui você pode adicionar código de rastreamento
                        console.log('Usuário clicou em "Saiba Mais" - plataformas popup');
                        
                        // Marcar como exibido quando o usuário interage com o botão
                        markAsShown();
                    });
                }
            });
